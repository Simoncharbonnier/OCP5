      ...
      <div class="modal-content">
        <form enctype="multipart/form-data" id="form-add-post" method="POST" action="?controller=post&action=add">
          ...
          <div class="modal-body">
            <h1><input type="text" name="title" placeholder="Le titre de votre futur article préféré" autocomplete="off" required></h1>
            <h2><input type="text" name="headline" placeholder="Vous pouvez écrire son chapô juste ici !" autocomplete="off" required></h2>
